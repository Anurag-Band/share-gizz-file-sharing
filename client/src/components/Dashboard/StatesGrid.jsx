      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-8">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-500 mb-1">{user?.email || "user@example.com"}</p>
            <p className="text-sm text-gray-400 mb-3">@{user?.username || "username"}</p>
          ...
          >
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${card.color}`}>
                  {card.value}
                </p>
              </div>
